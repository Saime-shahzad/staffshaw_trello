...
const Modals = ({
  ...
  const modalTabs = [
    {
      ...
      component: (
        <ModalPopups onClick={getSelectedValue} data={viewCardData?.allUsers} />
      ),
    },
    {
      tabName: "Labels",
  ...
  const cardMembers = viewCardData?.members?.filter(
    (item) => Number(item.id) === Number(localStorage?.getItem("userId"))
  );
        ...
        <Modal
          title={
            title ? (
              ...
              <div>
                <div>{title || viewCardData?.listTitle}</div>
                {!isLoader && (
                        ...
                        <div className="detail-Input-Description ">
                          {viewCardData?.card?.description && !openTextField ? (
                            <div className="viewDescription-parent">
                              <div>{viewCardData?.card?.description}</div>
                              <div
                                className="edit-description-button text-info"
                    ...
                    <div>
                      ...
                      <div className="button-parent d-flex justify-content-end w-50 pt-2">
                        <Buttons
                          ...
                          className="buttonstyle d-flex justify-con"
                        />
                      </div>
                    </div>
                  )}
